...
public class TrailerHistoryListModel extends BaseObservable implements Parcelable {
    ...
    public TrailerHistoryListModel() {

    }


    protected TrailerHistoryListModel(Parcel in) {
        arrayList = in.createTypedArrayList(TrailerHistoryModel.CREATOR);
    ...
    public static final Creator<TrailerHistoryListModel> CREATOR = new Creator<TrailerHistoryListModel>() {
        @Override
        public TrailerHistoryListModel createFromParcel(Parcel in) {
            return new TrailerHistoryListModel(in);
        }

        @Override
        public TrailerHistoryListModel[] newArray(int size) {
            return new TrailerHistoryListModel[size];
        }
    };
    ...
    public ArrayList<TrailerHistoryModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<TrailerHistoryModel> arrayList) {
