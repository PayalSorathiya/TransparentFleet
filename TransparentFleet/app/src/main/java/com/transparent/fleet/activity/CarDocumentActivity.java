...
import com.transparent.fleet.databinding.ActivityViewCardocumentBinding;
import com.transparent.fleet.databinding.ActivityViewDocumentBinding;
import com.transparent.fleet.fragment.FragmentCar;
...
public class CarDocumentActivity extends BaseActivity implements View.OnClickListener , OpenFragment {
    public static final String TAG = "HistoryActivity";
    public static DocumentListModel model;
    private ActivityViewCardocumentBinding binding;
    ...
    public void setModelAndBinding() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_view_cardocument);
...
//        model.setCardModelArrayList(new ArrayList<CardModel>());
    ...
    private void createTabIcons() {
        ...
        String[] tabName = {getString(R.string.car), getString(R.string.driver)};
    ...
    private void setupViewPager() {
        ...
        mAdapter.addFragment(fragmentCar, getString(R.string.car));
