...
import com.transparent.fleet.databinding.RowServiceItemBinding;
...
public class ServiceAdapter extends RecyclerView.Adapter {
    ...
    public ServiceAdapter(Context context, ArrayList<ServiceModel> arrayList, OnRecyclerItemClick onItemClick) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_service_item, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder vh, int position) {
        if (vh instanceof MyViewHolder) {
            ...
            h.binding.setServiceModel(arrayList.get(position));
...
//        imageLoader.displayImage(arrayList.get(position).getAttachments(), vh.imageView, options);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private RowServiceItemBinding binding;
