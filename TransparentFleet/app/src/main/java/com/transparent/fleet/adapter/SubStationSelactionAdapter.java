...
public class SubStationSelactionAdapter extends RecyclerView.Adapter {
    ...
    public SubStationSelactionAdapter(Context context, ArrayList<SubStationModel> arrayList, OnRecyclerItemClick onItemClick) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_substation_item, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder vh, int position) {
        if (vh instanceof MyViewHolder) {
            ...
            h.binding.setSubStationModel(arrayList.get(position));
...
//        imageLoader.displayImage(arrayList.get(position).getAttachments(), vh.imageView, options);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private RowSubstationItemBinding binding;
