...
public class FragmentTruck extends BaseFragment implements View.OnClickListener {
    ...
    private void fillArrayList() {
        ...
        String[] docName = {"Registration Certificate", "Registration Number","Insurance Certificate", "Cvrt Certificate", "Cop Certificate"};
        String[] docUrl = {ActivityChooseTruck.model.getRegistration_certificate_url(),
                ActivityChooseTruck.model.getRegistration_number(),
                ActivityChooseTruck.model.getInsurance_papers_url(),
                ActivityChooseTruck.model.getCvrt_url(),
                ActivityChooseTruck.model.getCop_url(),
        };
