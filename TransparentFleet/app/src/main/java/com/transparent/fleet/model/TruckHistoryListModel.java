...
public class TruckHistoryListModel extends BaseObservable implements Parcelable {
    ...
    public TruckHistoryListModel() {

    }


    protected TruckHistoryListModel(Parcel in) {
        arrayList = in.createTypedArrayList(TruckHistoryModel.CREATOR);
    ...
    public static final Creator<TruckHistoryListModel> CREATOR = new Creator<TruckHistoryListModel>() {
        @Override
        public TruckHistoryListModel createFromParcel(Parcel in) {
            return new TruckHistoryListModel(in);
        }

        @Override
        public TruckHistoryListModel[] newArray(int size) {
            return new TruckHistoryListModel[size];
        }
    };
    ...
    public ArrayList<TruckHistoryModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<TruckHistoryModel> arrayList) {
