...
import com.transparent.fleet.databinding.RowCardItemBinding;
...
public class CardAdapter extends RecyclerView.Adapter {
    ...
    public CardAdapter(Context context, ArrayList<CardModel> arrayList, OnRecyclerItemClick onItemClick) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_card_item, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder vh, int position) {
        if (vh instanceof MyViewHolder) {
            ...
            h.binding.setCardModel(arrayList.get(position));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private RowCardItemBinding binding;
