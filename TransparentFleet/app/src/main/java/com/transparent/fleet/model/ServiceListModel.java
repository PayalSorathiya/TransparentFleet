...
public class ServiceListModel extends BaseObservable implements Parcelable {
    private ArrayList<ServiceModel> arrayList;
    private ArrayList<ServiceModel> latestArrayList;
    ...
    protected ServiceListModel(Parcel in) {
        arrayList = in.createTypedArrayList(ServiceModel.CREATOR);
        latestArrayList = in.createTypedArrayList(ServiceModel.CREATOR);
    ...
    public ArrayList<ServiceModel> getLatestArrayList() {
        return latestArrayList;
    }

    public void setLatestArrayList(ArrayList<ServiceModel> latestArrayList) {
    ...
    public void setArrayList(ArrayList<ServiceModel> arrayList) {
