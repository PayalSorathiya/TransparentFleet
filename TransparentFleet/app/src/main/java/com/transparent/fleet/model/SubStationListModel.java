...
public class SubStationListModel extends BaseObservable implements Parcelable {
    private ArrayList<SubStationModel> arrayList;
    ...
    public SubStationListModel() {

    }

    protected SubStationListModel(Parcel in) {
        arrayList = in.createTypedArrayList(SubStationModel.CREATOR);
    ...
    public static final Creator<SubStationListModel> CREATOR = new Creator<SubStationListModel>() {
        @Override
        public SubStationListModel createFromParcel(Parcel in) {
            return new SubStationListModel(in);
        }

        @Override
        public SubStationListModel[] newArray(int size) {
            return new SubStationListModel[size];
        }
    };
    ...
    public ArrayList<SubStationModel> getArrayList() {
        return arrayList;
    }

    public void setArrayList(ArrayList<SubStationModel> arrayList) {
