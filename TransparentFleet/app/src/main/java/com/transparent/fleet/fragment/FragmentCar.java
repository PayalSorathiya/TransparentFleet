...
import com.transparent.fleet.activity.ActivityChooseCar;
...
public class FragmentCar extends BaseFragment implements View.OnClickListener {
    ...
    private void fillArrayList() {
        ...
        String[] docName = {"Registration Certificate", "Registration Number", "Insurance Certificate", "Annual Testing Certificate", "More Document"};
        String[] docUrl = {ActivityChooseCar.model.getRegistration_certificate_url(),
                ActivityChooseCar.model.getRegistration_number(),
                ActivityChooseCar.model.getInsurance_papers_url(),
                ActivityChooseCar.model.getAnnual_testing_certificate_url(),
                ActivityChooseCar.model.getMore_documents_url(),
        };
